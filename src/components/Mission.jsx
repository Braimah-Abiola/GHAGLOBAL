...
const Mission = () => {
    return (
        <div className="flex flex-col max-w-[1440px] mx-auto w-full items-center md:mt-[5rem]">
            <div className="bg-[#F3F3F3] flex flex-col rounded-[20px] items-center justify-center px-20 py-10">
                ...
                <p className="text-center mt-4 services_description">
